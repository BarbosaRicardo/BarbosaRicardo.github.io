...
<html>
	<head>
		...
		<title>Ricardo's CSUMB Portfolio</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper" class="fade-in">
				...
				<!-- Intro -->
					<div id="intro">
						<img class = "image main" src = "images/ps_flat_logo.jpg">

						<h1>Ricardo Barbosa<br />
						CSUMB Portfolio</h1>
						<p>A portfolio that shows the process and the work created by Ricardo Barbosa while in attendance at  <a href="https://csumb.edu">Cal State Monterey Bay</a><br />
						</p>
						<ul class="actions">
					...
					<div id="main">
						...
						<!-- Featured Post -->
							<article class="post featured">
								...
								<ul class="actions special">
									<li><a href="https://ricardo-csumb.blogspot.com" class="button large">Learning Journal</a></li>
								</ul>
							</article>
						...
						<!-- Posts -->
							<section class="posts">
								<article>
									<header>
										<span class="date">Fall 2019 Term A</span>
										<h2><a href="https://learn.lambdaschool.com/fsw/module/recl0IyzS2Vl89lZa">CST 300 
										</a>Major ProSeminar<br><br></h2>
									</header>
									<a href="https://unsplash.com" class="image fit"><img src="images/cst300.jpg" alt="" /></a>
									<p>
											This is the first class in the 100 week program...
									</p>
									
									<!-- Button trigger modal -->
											<button type="button" class="actions special" data-toggle="modal" data-target="#exampleModal">
											  Learn More
											</button>
											  ...
											  <div class="modal-dialog" role="document">
												<div class="modal-content">
												  <div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel">CST 300</h5>
													<button type="button" class="close" data-dismiss="modal" aria-label="Close">
													  <span aria-hidden="true">&times;</span>
													</button>
												  </div>
												  <div class="modal-body">
													<p>This is the first course in the 100 week program which helps students identify and articulate personal professional and social goals. 
														Provides an integrated overview of the computer science and communication design majors and their requirements. 
														Students develop a plan for their learning goals. 
														...
														[Prereq: (GE Areas A1 and A2 and A3 with a C- or better) and (Junior or Senior Standing)]
													</p>
												  </div>
								...
								<article>
									<header>
										<span class="date">Fall 2019 Term B</span>
										<h2><a href="#">CST 338 Software Design<br> <br />
										</a></h2>
									</header>
									...
									<ul class="actions special">
										...
										<!-- Button trigger modal -->
										<button type="button" class="actions special" data-toggle="modal" data-target="#exampleModal1">
												Learn More
											  </button>
											  ...
											  <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
												  <div class="modal-content">
													<div class="modal-header">
													  <h5 class="modal-title" id="exampleModalLabel">CST 338</h5>
													  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
														<span aria-hidden="true">&times;</span>
													  </button>
													</div>
													<div class="modal-body">
														<p>		
															...
															Coverage includes the introduction to Java programming language, object-oriented programming, software life cycle and development processes, requirements analysis, and graphical user interface development. 
								...
								<article>
									<header>
										<span class="date">Spring 2020 Term B</span>
								...
								<article>
									<header>
										<span class="date">Summer 2020 Term A</span>
								...
								<article>
									<header>
										<span class="date">Summer Term B</span>
								...
								<article>
										<header>
											<span class="date">Fall 2020 Term A (double up)</span>
								...
								<div class="modal fade" id="exampleModal8" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									...
									<article>
											<header>
												<span class="date">Spring 2021 Term A</span>
								...
								<div class="modal fade" id="exampleModal9" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									...
									<article>
											<header>
												<span class="date">Spring 2021 Term B</span>
								...
								<div class="modal fade" id="exampleModal10" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									...
									<article>
											<header>
												<span class="date">Summer 2021 Term A</span>
				...
				<!-- Footer -->
					<footer id="footer">
						...
						<section class="split contact">
							<!-- <section class="alt">
								<h3>Address</h3>
								<p>Somewhere On This Blue Island<br />
								Some Diego, CA 00000</p>
							</section>
							<section>
								<h3>Phone</h3>
							...
							<section>
								<h3>Email</h3>
								<p><a href="#">rbarbosa@csumb.edu</a></p>
							</section>
							<!-- <section>
								<h3>Social</h3>
								<ul class="icons alt">
